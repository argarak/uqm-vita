/*
** The code from this file was taken from the devilutionX project and
** specifically the vita port code.
** https://github.com/diasurgical/devilutionX/blob/master/Source/platform/vita/keyboard.cpp
**
** The terms of use for the source code to devilutionX is under the Unlicense:
** https://github.com/diasurgical/devilutionX/blob/master/LICENSE
**
 */
